      ...
      <aside className="w-full md:w-64 bg-white border-r border-gray-200 flex flex-col justify-between shrink-0">
        <div>
          ...
          <nav className="p-4 space-y-1.5">
            <Link
              href="/parent"
              className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium text-purple-900 bg-purple-50 transition"
            >
        ...
        <div className="p-4 border-t border-gray-100">
          <div className="p-3 bg-slate-50 rounded-xl flex items-center justify-between">
            <div className="truncate pr-2">
              ...
              <p className="text-[11px] text-purple-700 font-medium">Guardian Account</p>
            </div>
            <Link
        ...
        <header className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:block">
            <h1 className="text-sm font-semibold text-gray-700">
              Parent Console • <span className="text-purple-700 font-bold">{userName}</span>
            </h1>
          </div>
          ...
          <div className="flex items-center gap-3">
            <Link
              ...
              className="text-xs font-semibold text-gray-600 hover:text-purple-700 transition"
            >
              Security
            </Link>
          </div>
